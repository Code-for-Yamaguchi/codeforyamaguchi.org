    ...
    return (
        <ul className="flex mx-10 justify-center flex-col　md:flex-row flex-wrap">
            {activity.map((activity) => (
                ...
                >
                    <Image className="flex justify-center" src={activity.icon} alt={activity.act} layout="fixed" width={150} height={150}/>

                    <h3 className="mt-6 mb-4 text-gray-900 text-2xl font-medium">{activity.act}</h3>
