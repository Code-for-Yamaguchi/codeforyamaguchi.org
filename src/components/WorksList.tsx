...
const works = [
    {
        ...
        desc: '東京都のOSSをもとに山口県版を作成し、運用を行っています。山口県庁の方々に管理していただいているオープンデータを利用してデータを可視化しています。',
        tag: 'Doing',
            ...
            {works.map((work) => (
                ...
                >
                    <a href={work.url} className="px-10">
                        <Image className="flex justify-center" src={work.image} alt={work.work} layout="fixed" width={300} height={150}/>
